...
class User extends Model{
    ...
    public static function login($login, $password)
    {
        ...
        if (password_verify($password, $data["despassword"])=== true)
        {
            ...
            $_SESSION[User::SESSION] = $user->getValues();//criar uma sessão para verificar se o usuário está logado
...
public static function validForgotDecrypt($code)
{
    ...
    ", array(
        ":idrecovery" => $idrecovery //usei o :variavel para repassar os dados por parametro atraves do array
    ));
